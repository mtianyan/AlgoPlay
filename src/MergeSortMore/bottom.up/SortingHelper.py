...
def sort_test(sort_name, arr):
    ...
    if sort_name == "SelectionSort":
        ...
        import MergeSort
        return MergeSort.MergeSort.sort(arr)
    elif sort_name == "MergeSort2":
        import MergeSort
        return MergeSort.MergeSort.sort2(arr)
    elif sort_name == "MergeSortBU":
        import MergeSort
        return MergeSort.MergeSort.sortBU(arr)
    if not is_sort(arr):
